...
Design goals:
- Low RAM: stream the text file line-by-line.
- Minimal dependencies: relies on `pdftotext -layout` (Poppler).
...
Output JSON:
{
  ...
  "count": <int>,
  "aircraft": {
     "A388": {"designator_raw":"A388","icao_wtc":"Heavy","recat_1_5":"A","recat_2_0_apdx_a":"A","recat_2_0_apdx_b":"NOWGT","cwt":"A"},
     ...
  }
}
"""
